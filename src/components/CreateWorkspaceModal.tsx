        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            ...
            <input
              ...
              type="text"
              required
              placeholder="e.g. College Project, Startup Project"
              value={name}
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Final year project or team mission..."
              value={description}
          ...
          <div className="p-3.5 bg-indigo-500/10 rounded-2xl border border-indigo-500/20 text-xs text-indigo-200 leading-relaxed">
            <strong className="text-white">Note:</strong> You will automatically become the <span className="font-bold text-indigo-300">ADMIN</span> of this workspace, with permissions to add members, create boards, and manage settings.
          </div>
